...
<section class="hero">
  ...
  <div class="hero-text white text-center">
    ...
    <p class="light-grey mb-m">
      ...
      calucating my cost of living, choosing an apartment. That's why I wrote
      this e-book, to tell you how I did it. No bullshite, no stress.
    </p>
    <Button onclick={() => console.log("clicked on hero section")}>Purchase E-book for $10</Button>
  </div>
</section>
